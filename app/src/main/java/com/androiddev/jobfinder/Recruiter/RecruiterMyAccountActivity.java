...
public class RecruiterMyAccountActivity extends AppCompatActivity {
        ...
        okay_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (gender.equals("Gender")){
                    Toast.makeText(RecruiterMyAccountActivity.this, "Please Select your gender", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                databaseReference.child("Users").child(phone).child("gender").setValue(gender).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(RecruiterMyAccountActivity.this, "User information updated", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
