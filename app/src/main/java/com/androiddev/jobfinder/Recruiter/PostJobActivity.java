...
// Un recruteur peut créer et publier une offre d'emploi
public class PostJobActivity extends AppCompatActivity {

    EditText name_box, timing_box, salary_box, skills_box,phone_box,location_box,education_box, desc_box, cregis_box;
    // Des FrameLayout pour les boutons, et un ImageView pour l'image de l'offre d'emploi.
    FrameLayout post_btn, addImage_btn;

    public static ImageView imageView;
    // Des variables nécessaires pour la gestion de l'image de l'offre d'emploi
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Définir un click listener sur le bouton retour
        ...
        // Récupération des données de l'utilisateur depuis les préférences partagées.
...
//        name_box.setText(name_s);
        ...
        post_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String phone_s = phone_box.getText().toString();
                ...
                if (name.equals("")){
                    Toast.makeText(PostJobActivity.this, "Please Enter Name", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (phone_s.equals("")){
                    Toast.makeText(PostJobActivity.this, "Please Enter Phone", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (skills.equals("")){
                    Toast.makeText(PostJobActivity.this, "Please Enter Subject", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (location.equals("")){
                ...
                if (education.equals("")){
                    Toast.makeText(PostJobActivity.this, "Please Enter Education", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (salary.equals("")){
                    Toast.makeText(PostJobActivity.this, "Please Enter Pricing", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (timing.equals("")){
                ...
                if (cid.equals("")){
                    Toast.makeText(PostJobActivity.this, "Please Enter Registration Number", Toast.LENGTH_SHORT).show();
                    return;
                }


                if (imageView.getDrawable() == null) {
                    Toast.makeText(PostJobActivity.this, "Please Select Image", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                fileRef.putFile(imageFilePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            // Création de l'objet PostModule avec les informations de l'offre d'emploi
                            @Override
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressBar.setVisibility(View.GONE);
                        post_btn.setVisibility(View.VISIBLE);
                        Toast.makeText(PostJobActivity.this, "Uploading Failed !!", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    // Cette méthode est appelée lorsque l'utilisateur a sélectionné une image dans la galerie
    @Override
